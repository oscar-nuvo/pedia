      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-neutral-200">
            <h3 className="text-2xl font-semibold mb-6 text-neutral-800">Your Practice Details</h3>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full h-2 bg-neutral-100 rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-primary [&::-webkit-slider-thumb]:cursor-pointer"
                />
              ...
              <div>
                ...
                <div className="flex justify-between text-sm text-neutral-500 mt-1">
                  <span>1hr</span>
                  <span className="font-semibold text-primary">{hoursPerDay}hrs</span>
                  <span>6hrs</span>
                </div>
              </div>
          ...
          {/* Results */}
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-secondary-orange to-secondary-peach text-white rounded-2xl p-8 shadow-sm">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-neutral-200">
              ...
              <h4 className="text-lg font-semibold mb-2 text-neutral-800">Monthly Value Creation</h4>
              <p className="text-3xl font-bold text-secondary-orange">${monthlySavings.toLocaleString()}</p>
              <p className="text-sm text-neutral-600">From time savings alone</p>
            </div>

            <div className="bg-gradient-to-br from-secondary-purple/20 to-primary/20 rounded-2xl p-8 shadow-sm border border-secondary-purple/30">
              <TrendingUp className="w-8 h-8 text-primary mb-4" />
              <h4 className="text-lg font-semibold mb-2 text-neutral-800">Annual ROI</h4>
              <p className="text-3xl font-bold text-primary">${annualSavings.toLocaleString()}</p>
              <p className="text-sm text-neutral-600">vs. ${(providers * 1800).toLocaleString()} platform cost</p>
              <p className="text-lg font-bold text-secondary-orange mt-2">
        ...
        <div className="text-center mt-12">
          ...
          <button className="bg-gradient-to-r from-primary to-secondary-orange text-white px-8 py-4 rounded-full font-semibold hover:shadow-lg hover:shadow-primary/30 transition-all">
